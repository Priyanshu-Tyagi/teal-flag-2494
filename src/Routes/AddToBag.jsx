      ...
      <div style={{ width: "78%", margin: "auto" }}>
        ...
        <div style={{ display: "flex", justifyContent:"space-between",width:"90%", margin:"auto"}}>
          ...
          <div style={{marginTop:"2rem", width:"35%"}}>
            <div style={{borderBottom:"1px solid #95a2a5",marginBottom:".6rem"}}>
            ...
            <div>
              ...
              <div>
              <img src="https://drive.google.com/uc?export=view&id=1S-sy8IltDcHp2H5srX65INou0olY1kLY" alt="1S-sy8IltDcHp2H5srX65INou0olY1kLY" />
              {/* https://drive.google.com/file/d/1S-sy8IltDcHp2H5srX65INou0olY1kLY/view?usp=sharing */}
              </div>
              <div>
                <Button width="100%" color="white" py={"1rem"} backgroundColor={"#00819d"} _hover={{backgroundColor:"white", color:"#00819d"}}>
                    Check Out
                </Button>
              </div>
              <div>
                <img src="https://drive.google.com/uc?export=view&id=15vYvxRqUaRzoe0fCv17o7XkuK0hW2krN" alt="15vYvxRqUaRzoe0fCv17o7XkuK0hW2krN" />
